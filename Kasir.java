...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        ...
        // ? Loop untuk memunculkan daftar meja
    ...
    public void tambahPesanan(int nomorMeja, Menu menu) {
        ...
        // ? Validasi sudah ditaruh di main method???
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    Pelanggan pelangganBaru = new Pelanggan(scanner.nextLine());

                    tambahPelanggan(nomorMeja, pelangganBaru);
                    break;
                ...
                case 4:
                    ...
                    hapusPelanggan(scanner.nextInt());
                    scanner.nextLine();
                ...
                case 5:
                    ...
                    if(hitungHargaPesanan(nomorMejaPesan) == 0) {
                ...
                case 6:
                    ...
                    tampilkanPesanan(scanner.nextInt());
                    scanner.nextLine();
